...
#define STRING_CONFIG_H_AUTHOR "(drackp2m, Super Racer)" // Who made the changes.
...
#define MACHINE_UUID "4c668e85-89bf-472b-b4e1-fd3224cf1de6"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  91.55
  #define DEFAULT_bedKi  18.20
  #define DEFAULT_bedKd 306.99
...
#define DELTA
  ...
  //#define DELTA_MAX_RADIUS       147.0    // (mm)
  ...
  #define DELTA_RADIUS 152.00             // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.00, 0.00, 0.00 } // Get these values from G33 auto calibrate
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 400, 400, 400, 80 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -16.00 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, (Y_MIN_POS + 20), 20 }
