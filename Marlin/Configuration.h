...
#define STRING_CONFIG_H_AUTHOR "(Luis, Gordo Soldevila)" // Who made the changes.
 ...
 *
 */
// FixMe => Search sensors types
#define TEMP_SENSOR_0 30
#define TEMP_SENSOR_1 30
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 10), (Y_MIN_POS), 50 }
